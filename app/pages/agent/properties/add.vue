...
const ongoing_units = ref(0)
const available_units = ref(0)
    ...
    <div class="form">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="form_group">
          ...
          <div class="form_holder">
            <div class="form-icon">
              <img class="icon" src="/bed.png" alt="beds">
            </div>
            <div class="input">
        ...
        <div class="form_group">
          <div class="form_holder">
            <div class="form-icon">
              <img class="icon" src="/bath.png" alt="bathrooms">
            </div>
            <div class="input">
          ...
          <div class="form_holder">
            <div class="form-icon">
              <img class="icon" src="/car.png" alt="parking">
            </div>
            <div class="input">
